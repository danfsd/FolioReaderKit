...
class FolioReaderPlayerMenu: UIViewController, SMSegmentViewDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        playPauseBtn.setTitleColor(selectedColor, for: .normal)
        playPauseBtn.setTitleColor(selectedColor, for: .selected)
        playPauseBtn.setImage(playSelected, for: .normal)
        ...
        style0.setTitleColor(isNight(readerConfig.nightModeMenuBackground, UIColor.white), for: .normal)
        style0.setTitleColor(isNight(readerConfig.nightModeMenuBackground, UIColor.white), for: .selected)
        style0.setTitle(readerConfig.localizedPlayerMenuStyle, for: .normal)
        ...
        style1.setTitleColor(normalColor, for: .normal)
        ...
        style2.setTitleColor(normalColor, for: .normal)
        style2.setTitleColor(selectedColor, for: .selected)
        style2.setTitle(readerConfig.localizedPlayerMenuStyle, for: .normal)
        ...
        style0.isSelected = (FolioReader.sharedInstance.currentMediaOverlayStyle == .default)
        style1.isSelected = (FolioReader.sharedInstance.currentMediaOverlayStyle == .underline)
        style2.isSelected = (FolioReader.sharedInstance.currentMediaOverlayStyle == .textColor)
